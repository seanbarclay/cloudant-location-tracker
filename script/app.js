...
/*
 NOTE: first create an index w/ a POST request to your Cloudant DB:

 https://USERNAME:PASSWORD@USERNAME.cloudant.com/locationtracker/_index

 {
    "selector": {"properties.timestamp"},
    "sort": [{"properties.timestamp": "asc"}]
}

After the index is set, the _find POST request will work.
